...
.controller('EditQuizController', function($scope, $http, $location, $window) {
	...
	pic_url: 'http://www.keenthemes.com/preview/metronic/theme/assets/global/plugins/jcrop/demos/demo_files/image2.jpg',
	questions: [
	    {
	...
	$http.post("/api/quiz/"+ $scope.currentQuizId, $scope.quiz)
	.success(function(data) {
	    console.log(data);
